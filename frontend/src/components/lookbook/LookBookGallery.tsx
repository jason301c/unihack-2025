...
export default function LookBookGallery({ looks, onSelectLook }: LookBookGalleryProps) {
  return (
    <div className="min-h-screen bg-white text-black p-6">
      <h1 className="text-3xl font-semibold mb-6 text-prim-darkest">Your Look Book</h1>
        ...
        {looks.map((look, index) => (
          ...
          >
            ...
            <div className="p-4 transition-colors duration-200 hover:bg-gray-200">
              <p className="font-semibold text-center text-prim-darkest">{look.name}</p>
            </div>
          </div>
        ))}
      </div>
