    ...
    <div className="flex flex-col h-screen bg-white text-black">
      ...
      <div className="flex flex-1 items-center justify-center">
        <div className="w-86 h-115 border-2 border-gray-300 rounded-md flex items-center justify-center">
          <Image src="/images/portrait-placeholder.png" alt="Portrait" width={120} height={160} />
        </div>
      </div>
      ...
      <div className="p-4 w-full max-w-md mx-auto">
        ...
        {/* Stacked Buttons */}
        <button className="w-full p-3 bg-blue-500 text-white rounded-md shadow-md hover:bg-blue-600 transition mb-3">
          Save Look
        </button>
        <button className="w-full p-3 bg-gray-300 text-gray-700 rounded-md shadow-md hover:bg-gray-400 transition">
          Cancel
        </button>
      </div>
    </div>
